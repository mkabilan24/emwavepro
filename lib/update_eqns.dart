...
void update1CompEqns (String a_E_Field_Propagation_1, String a_H_Field_Propagation_1, String a_k_Wave_Propagation_1, MathFieldEditingController _E0, MathFieldEditingController _H0, MathFieldEditingController _phi) {
    
    //Wave Propagation on X-axis
    if (a_k_Wave_Propagation_1 == '+\\vec{a}_x') {
    setETimeDomainEquation1('\\vec{E} =  $a_E_Field_Propagation_1 ${_isMFControllerEmpty(_E0) ? '|E_{0}|' : _E0.currentEditingValue()}\\cos(\\omega t - kx + ${_isMFControllerEmpty(_phi) ? '\\phi' : _phi.currentEditingValue()})');
