...
class MainWidgetState extends State<MainWidget> {
  ...
  final List<String> vect_options2 = [
    '+\\vec{a}_x',
    '-\\vec{a}_x',
    '+\\vec{a}_y',
    '-\\vec{a}_y',
          ...
          Visibility(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Math.tex('\\text{Wave propagation: }\\vec{a}_k=', textStyle: const TextStyle(fontSize: 18),),
                    const SizedBox(width: 10),
                    Expanded(
                      child: MathDropdown(
                        initialValue: a_k_Wave_Propagation_1,
                        options: vect_options,
                        onChanged: (newValue) {
                          setState(() {
                            a_k_Wave_Propagation_1 = newValue;
                            _update1CompEqns();
                          });
                        },
                      ),
                ...
                Row(
                  children: [
                    Math.tex('\\vec{E} = ', textStyle: const TextStyle(fontSize: 22)),
                    SizedBox(
                      width: 100, // Set a fixed width for the dropdown
                      child: MathDropdown(
                        initialValue: a_E_Field_Propagation_1,
                        options: ["\\vec{a}_E"] + vect_options2,
                        onChanged: (newValue) {
                    ...
                    Math.tex('|', textStyle: const TextStyle(fontSize: 22)),
                    SizedBox(
                      width: 80, // Set a fixed width for the MathFieldWithHint
                      child: MathFieldWithHint(
                        controller: _E0,
                        hintText: 'E_{0}',
                        onChanged: _update1CompEqns,
                      ),
                    ),
                    Math.tex(
                      '|\\cos(\\omega t ${a_k_Wave_Propagation_1[0]}k${a_k_Wave_Propagation_1[a_k_Wave_Propagation_1.length - 1]} + ',
                      textStyle: const TextStyle(fontSize: 22),
                    ),
                    SizedBox(
                      width: 80, // Set a fixed width for the second MathFieldWithHint
                      child: MathFieldWithHint(
                        controller: _phi,
                        hintText: '\\phi',
                        onChanged: _update1CompEqns,
