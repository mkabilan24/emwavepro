...
import 'package:emwavepro/0_Main_Version/Lossy/8_Lossy_PropagationConstant.dart';
import 'package:emwavepro/0_Main_Version/Lossy/9_Lossy_AttenuationConstant.dart';
import 'package:emwavepro/0_Main_Version/Lossy/10_Lossy_PhaseConstant.dart';
...
class LossyWaveEMPropertiesWidget extends StatefulWidget {
  @override
  _LossyWaveEMPropertiesWidgetState createState() => _LossyWaveEMPropertiesWidgetState();
}

class _LossyWaveEMPropertiesWidgetState extends State<LossyWaveEMPropertiesWidget> {
  @override
  void initState() {
    super.initState();
    calc_losstangent();
