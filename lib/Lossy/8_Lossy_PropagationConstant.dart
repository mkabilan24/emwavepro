...
void calc_propagation_constant() {
  ...
  print(
      "The value of Propagation Constant is: ${propagation_constant.toString()}");
...
class Lossy_PropagationConstantDisplayWidget extends StatefulWidget {
  @override
  _Lossy_PropagationConstantDisplayWidgetState createState() =>
      _Lossy_PropagationConstantDisplayWidgetState();
}

class _Lossy_PropagationConstantDisplayWidgetState
    extends State<Lossy_PropagationConstantDisplayWidget> {
